"""
Script to create the complete Jupyter Notebook for Week 1 Data Acquisition, Cleaning & Preprocessing.
"""
...
def generate_notebook():
    ...
    # Cell 5: Missingness Audit (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 9: Outlier Treatment (Markdown)
    cells.append({
        "cell_type": "markdown",
        "metadata": {},
        "source": [
    ...
    # Cell 12: Feature Engineering Code
    cells.append({
        "cell_type": "code",
        "execution_count": 6,
        "metadata": {},
    ...
    with open("Week_1_Data_Cleaning_and_Preprocessing.ipynb", "w", encoding="utf-8") as f:
        json.dump(notebook_content, f, indent=2)
        
    print("[OK] Successfully generated 'Week_1_Data_Cleaning_and_Preprocessing.ipynb'.")
